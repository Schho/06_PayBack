    ...
    <form action="index.php" method="post">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input class="form-control" min="0" type="number" id="people" name="raten" value="<?= $raten ?>">
            </div>
            <div class="form-group">
                <label class="form-label" for="people">Welches Kreditpacket wählen Sie?</label>
                <input class="form-control" min="0" type="text" id="people" name="packet" value="<?= $packet ?>">
            </div>
        </fieldset>
